...
export default function About() {
  return (
   <>
   <h1>Welcome to EdxTrade!</h1>
   <p>At EdxTrade, we understand the unique needs of students and the importance of having the right tools and resources at your disposal. Our platform was created with one goal in mind: to make it easier for students to buy and sell essential items related to their education.
